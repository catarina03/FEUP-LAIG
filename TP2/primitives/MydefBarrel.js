...
class MydefBarrel extends CGFobject {
	 ...
	 * @param {CGFscene} scene refers to MyScene object
	 * @param {Number} base - base size
	 * @param {Number} middle - middle part size
	 * @param {Number} height - height of barrel
    ...
    /**
     * Generates control points for barrel
     */
