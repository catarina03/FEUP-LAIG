...
class LightingScene extends CGFscene
{
	init(application)
	{
		...
		this.hexagon = new CGFOBJModel(this, 'models/hexagon.obj');
		this.checker = new CGFOBJModel(this, 'models/checker.obj');
		this.skull = new CGFOBJModel(this, 'models/skull.obj');
